...
@section('content')
    ...
    @component('componentes.box', ['title' => 'Editar Insumo', 'erro' => 1])

        @slot('action')

            <a class="btn white btn-outline btn blue-soft" href="{{route('enterprise.feedstock.list.get')}}">
                &nbsp;Voltar</a>
        @endslot

        {{Form::model($feedstock, ['route' => ['enterprise.feedstock.update.post', $feedstock->id], 'method' => 'post'])}}
